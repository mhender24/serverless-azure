//Topic Endpoint: https://serverless-eg-mhenderson.centralus-1.eventgrid.azure.net/api/events
...
function publishToEventGrid(speaker) {
  ...
  const topicHostName =
    "https://serverless-eg-mhenderson.centralus-1.eventgrid.azure.net/api/events";
  let data = speaker;
  let events = [
    {
      id: uuid(),
